...
## Estándares y reproducibilidad
- [BIDS Specification](https://bids.neuroimaging.io/)
- [BIDS Starter Kit](https://bids-standard.github.io/bids-starter-kit/)

## Software (docs oficiales)
- [FSL](https://fsl.fmrib.ox.ac.uk/fsl/docs/#/)
- [AFNI](https://afni.nimh.nih.gov/documentation)
...
- [ ] Dataset 1 — (modalidad, licencia)
- [ ] Dataset 2 — (modalidad, licencia)
